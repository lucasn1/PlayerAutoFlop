    ...
    return function(t) {
        ...
        function n(t, e) {
            ...
            var r, n = i(t),
                ...
                p = n.path,
                f = u[h] && p in u[h].nsps;
            return e.forceNew || e["force new connection"] || !1 === e.multiplex || f ? (c("ignoring socket cache for %s", s), r = a(s, e)) : (u[h] || (c("new io instance for %s", s), u[h] = a(s, e)), r = u[h]), n.query && !e.query ? e.query = n.query : e && "object" === o(e.query) && (e.query = function(t) {
                var e = [];
                for (var r in t) t.hasOwnProperty(r) && e.push(encodeURIComponent(r) + "=" + encodeURIComponent(t[r]));
                return e.join("&")
            }(e.query)), r.socket(n.path, e)
        }
        var o = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(t) {
            ...
            s = r(7),
            a = r(17),
            c = r(3)("socket.io-client");
        t.exports = e = n;
        var u = e.managers = {};
        e.protocol = s.protocol, e.connect = n, e.Manager = r(17), e.Socket = r(44)
    }, function(t, e, r) {
        (function(e) {
            "use strict";
            var n = r(2),
                o = r(3)("socket.io-client:url");
            t.exports = function(t, r) {
                var i = t;
                r = r || e.location, null == t && (t = r.protocol + "//" + r.host), "string" == typeof t && ("/" === t.charAt(0) && (t = "/" === t.charAt(1) ? r.protocol + t : r.host + t), /^(https?|wss?):\/\//.test(t) || (o("protocol-less url %s", t), t = void 0 !== r ? r.protocol + "//" + t : "https://" + t), o("parse %s", t), i = n(t)), i.port || (/^(http|ws)$/.test(i.protocol) ? i.port = "80" : /^(http|ws)s$/.test(i.protocol) && (i.port = "443")), i.path = i.path || "/";
        ...
        (function(n) {
            function o() {
                ...
                if (void 0 !== n && "env" in n) return n.env.DEBUG
        ...
        function n() {
            return e.colors[s++ % e.colors.length]
        }
        ...
        function o(t) {
            ...
            function o() {
                var t = o,
                    r = +new Date,
                    s = r - (i || r);
                t.diff = s, t.prev = i, t.curr = r, i = r, null == t.useColors && (t.useColors = e.useColors()), null == t.color && t.useColors && (t.color = n());
                ...
                a[0] = a[0].replace(/%([a-z%])/g, function(r, n) {
                    ...
                    return r
                }), a = e.formatArgs.apply(t, a), (o.log || e.log || console.log.bind(console)).apply(t, a)
            }
            r.enabled = !1, o.enabled = !0;
            var s = e.enabled(t) ? o : r;
            return s.namespace = t, s
        }(e = t.exports = o.debug = o).coerce = function(t) {
            ...
            return !1
        }, e.humanize = r(6), e.names = [], e.skips = [], e.formatters = {};
        var i, s = 0
    }, function(t, e) {
        function r(t) {
            return n(t, a, "day") || n(t, s, "hour") || n(t, i, "minute") || n(t, o, "second") || t + " ms"
        }
        ...
        t.exports = function(t, e) {
            ...
            if ("number" === n && !1 === isNaN(t)) return e.long ? r(t) : function(t) {
        ...
        function o(t) {
            var r = "",
                n = !1;
            return r += t.type, e.BINARY_EVENT != t.type && e.BINARY_ACK != t.type || (r += t.attachments, r += "-"), t.nsp && "/" != t.nsp && (n = !0, r += t.nsp), null != t.id && (n && (r += ",", n = !1), r += t.id), null != t.data && (n && (r += ","), r += h.stringify(t.data)), u("encoded %j as %s", t, r), r
        }
        ...
        function s(t) {
            var r = {},
                n = 0;
            if (r.type = Number(t.charAt(0)), null == e.types[r.type]) return c();
        ...
        var u = r(8)("socket.io-parser"),
            h = r(11),
            p = r(13),
            f = r(14),
            l = r(16);
        e.protocol = 4, e.types = ["CONNECT", "DISCONNECT", "EVENT", "ACK", "ERROR", "BINARY_EVENT", "BINARY_ACK"], e.CONNECT = 0, e.DISCONNECT = 1, e.EVENT = 2, e.ACK = 3, e.ERROR = 4, e.BINARY_EVENT = 5, e.BINARY_ACK = 6, e.Encoder = n, e.Decoder = i, n.prototype.encode = function(t, r) {
            (u("encoding packet %j", t), e.BINARY_EVENT == t.type || e.BINARY_ACK == t.type) ? function(t, e) {
                f.removeBlobs(t, function(t) {
                    var r = f.deconstructPacket(t),
                        n = o(r.packet),
                        i = r.buffers;
                    i.unshift(n), e(i)
                })
            ...
            var r;
            if ("string" == typeof t) r = s(t), e.BINARY_EVENT == r.type || e.BINARY_ACK == r.type ? (this.reconstructor = new a(r), 0 === this.reconstructor.reconPack.attachments && this.emit("decoded", r)) : this.emit("decoded", r);
            else {
        ...
        (e = t.exports = function(t) {
            ...
            function i() {
                var t = i,
                    r = +new Date,
                    s = r - (n || r);
                t.diff = s, t.prev = n, t.curr = r, n = r, null == t.useColors && (t.useColors = e.useColors()), null == t.color && t.useColors && (t.color = e.colors[o++ % e.colors.length]);
                ...
                a[0] = a[0].replace(/%([a-z%])/g, function(r, n) {
                    ...
                    return r
                }), "function" == typeof e.formatArgs && (a = e.formatArgs.apply(t, a)), (i.log || e.log || console.log.bind(console)).apply(t, a)
            }
            ...
            for (r = 0, n = e.names.length; r < n; r++)
                if (e.names[r].test(t)) return !0;
            return !1
        }, e.humanize = r(10), e.names = [], e.skips = [], e.formatters = {};
        var n, o = 0
    }, function(t, e) {
        function r(t, e, r) {
            if (!(t < e)) return t < 1.5 * e ? Math.floor(t / e) + " " + r : Math.ceil(t / e) + " " + r + "s"
        ...
        t.exports = function(t, e) {
            return e = e || {}, "string" == typeof t ? function(t) {
                ...
                return r(t, s, "day") || r(t, i, "hour") || r(t, o, "minute") || r(t, n, "second") || t + " ms"
            }(t) : function(t) {
                return t >= s ? Math.round(t / s) + "d" : t >= i ? Math.round(t / i) + "h" : t >= o ? Math.round(t / o) + "m" : t >= n ? Math.round(t / n) + "s" : t + "ms"
            }(t)
        }
    }, function(t, e, r) {
        (function(t, r) {
            (function() {
                function n(t, e) {
                    function r(t) {
                        ...
                        if ("bug-string-char-index" == t) n = "a" != "a" [0];
                        else if ("json" == t) n = r("json-stringify") && r("json-parse");
                        else {
                            ...
                            if ("json-stringify" == t) {
                                ...
                                if (h) {
                                    ...
                                    try {
                                        h = "0" === c(0) && "0" === c(new i) && '""' == c(new a) && c(v) === g && c(g) === g && c() === g && "1" === c(o) && "[1]" == c([o]) && "[null]" == c([g]) && "null" == c(null) && "[null,null,null]" == c([g, v, null]) && c({
                                            a: [o, !0, !1, null, "\0\b\n\f\r\t"]
                            ...
                            if ("json-parse" == t) {
                                ...
                                if ("function" == typeof p) try {
                                    if (0 === p("0") && !p(!1)) {
                                        var f = 5 == (o = p(s)).a.length && 1 === o.a[0];
                                        if (f) {
                                            try {
                                                f = !p('"\t"')
                                            } catch (t) {}
                    ...
                    if (!r("json")) {
                        ...
                        if (!b) var B = f.floor,
                            ...
                            T = function(t, e) {
                                return S[e] + 365 * (t - 1970) + B((t - 1969 + (e = +(e > 1))) / 4) - B((t - 1901 + e) / 100) + B((t - 1601 + e) / 400)
                            };
                        if ((d = m.hasOwnProperty) || (d = function(t) {
                                ...
                                for (i in (r = function() {
                                        this.valueOf = 0
                                    }).prototype.valueOf = 0, n = new r) d.call(n, i) && s++;
                                return r = n = null, s ? y = 2 == s ? function(t, e) {
                                    var r, n = {},
                                        o = v.call(t) == w;
                                    ...
                                    var r, i, s = v.call(t) == w,
                                        a = !s && "function" != typeof t.constructor && o[typeof t.hasOwnProperty] && t.hasOwnProperty || d;
                                    for (r in t) s && "prototype" == r || !a.call(t, r) || e(r);
                                    for (i = n.length; r = n[--i]; a.call(t, r) && e(r));
                                }), y(t, e)
                            }, !r("json-stringify")) {
                            var E = {
                                    92: "\\\\",
                                ...
                                j = function(t, e, r, n, o, i, s) {
                                    var a, c, u, h, f, l, m, b, w, C, S, E, O, P, R, D;
                                    try {
                                        a = e[t]
                                    } catch (t) {}
                                    if ("object" == typeof a && a)
                                        if ("[object Date]" != (c = v.call(a)) || d.call(a, "toJSON")) "function" == typeof a.toJSON && (c != k && c != x && c != A || d.call(a, "toJSON")) && (a = a.toJSON(t));
                                        else if (a > -1 / 0 && a < 1 / 0) {
                                        if (T) {
                                            for (f = B(a / 864e5), u = B(f / 365.2425) + 1970 - 1; T(u + 1, 0) <= f; u++);
                                            for (h = B((f - T(u, 0)) / 30.42); T(u, h + 1) <= f; h++);
                                            f = 1 + f - T(u, h), m = B((l = (a % 864e5 + 864e5) % 864e5) / 36e5) % 24, b = B(l / 6e4) % 60, w = B(l / 1e3) % 60, C = l % 1e3
                                        } else u = a.getUTCFullYear(), h = a.getUTCMonth(), f = a.getUTCDate(), m = a.getUTCHours(), b = a.getUTCMinutes(), w = a.getUTCSeconds(), C = a.getUTCMilliseconds();
                                        a = (u <= 0 || u >= 1e4 ? (u < 0 ? "-" : "+") + _(6, u < 0 ? -u : u) : _(4, u)) + "-" + _(2, h + 1) + "-" + _(2, f) + "T" + _(2, m) + ":" + _(2, b) + ":" + _(2, w) + "." + _(3, C) + "Z"
                                    } else a = null;
                                    ...
                                    if ("object" == typeof a) {
                                        for (P = s.length; P--;)
                                            if (s[P] === a) throw p();
                                        if (s.push(a), S = [], R = i, i += o, c == A) {
                                            for (O = 0, P = a.length; O < P; O++) E = j(O, a, r, n, o, i, s), S.push(E === g ? "null" : E);
                                            D = S.length ? o ? "[\n" + i + S.join(",\n" + i) + "\n" + R + "]" : "[" + S.join(",") + "]" : "[]"
                                        } else y(n || a, function(t) {
                                            var e = j(t, a, r, n, o, i, s);
                                            e !== g && S.push(N(t) + ":" + (o ? " " : "") + e)
                                        }), D = S.length ? o ? "{\n" + i + S.join(",\n" + i) + "\n" + R + "}" : "{" + S.join(",") + "}" : "{}";
                                        return s.pop(), D
                                    }
                            ...
                            e.stringify = function(t, e, r) {
                                ...
                                if (o[typeof e] && e)
                                    ...
                                    s = {};
                                    for (var c, u = 0, h = e.length; u < h; c = e[u++], ((a = v.call(c)) == x || a == k) && (s[c] = 1));
                                }
                                if (r)
                                    if ((a = v.call(r)) == k) {
                                        if ((r -= r % 1) > 0)
                                ...
                                return j("", ((c = {})[""] = t, c), i, s, n, "", [])
                            }
                        }
                        if (!r("json-parse")) {
                            var O, P, R = a.fromCharCode,
                                D = {
                                    92: "\\",
                                    34: '"',
                                    47: "/",
                                ...
                                U = function() {
                                    for (var t, e, r, n, o, i = P, s = i.length; O < s;) switch (o = i.charCodeAt(O)) {
                                        case 9:
                                        case 10:
                                        case 13:
                                        case 32:
                                        ...
                                        case 34:
                                            for (t = "@", O++; O < s;)
                                                ...
                                                case 114:
                                                    ...
                                                    break;
                                                case 117:
                                                    for (e = ++O, r = O + 4; O < r; O++)(o = i.charCodeAt(O)) >= 48 && o <= 57 || o >= 97 && o <= 102 || o >= 65 && o <= 70 || q();
                                                    t += R("0x" + i.slice(e, O));
                                                    break;
                                                default:
                                                    q()
                                            ...
                                            if (34 == i.charCodeAt(O)) return O++, t;
                                            q();
                                        default:
                                            if (e = O, 45 == o && (n = !0, o = i.charCodeAt(++O)), o >= 48 && o <= 57) {
                                ...
                                M = function(t) {
                                    ...
                                    if ("$" == t && q(), "string" == typeof t) {
                                        ...
                                        if ("[" == t) {
                                            for (e = [];
                                                "]" != (t = U()); r || (r = !0)) r && ("," == t ? "]" == (t = U()) && q() : q()), "," == t && q(), e.push(M(t));
                                            return e
                                        }
                                        if ("{" == t) {
                                            for (e = {};
                                                "}" != (t = U()); r || (r = !0)) r && ("," == t ? "}" == (t = U()) && q() : q()), "," != t && "string" == typeof t && "@" == (C ? t.charAt(0) : t[0]) && ":" == U() || q(), e[t.slice(1)] = M(U());
                                            return e
                                        }
                                        q()
                                    }
                            ...
                            e.parse = function(t, e) {
                                var r, n;
                                return O = 0, P = "" + t, r = M(U()), "$" != U() && q(), O = P = null, e && v.call(e) == w ? I(((n = {})[""] = r, n), "", e) : r
                            }
                        }
                    }
                ...
                var o = {
                    ...
                    i = o[typeof e] && e && !e.nodeType && e,
                    s = o[typeof window] && window || this,
                    a = i && o[typeof t] && t && !t.nodeType && "object" == typeof r && r;
                if (!a || a.global !== a && a.window !== a && a.self !== a || (s = a), i) n(s, i);
                else {
                    var c = s.JSON,
                        u = s.JSON3,
                        h = !1,
                        p = n(s, s.JSON3 = {
                            noConflict: function() {
                                return h || (h = !0, s.JSON = c, s.JSON3 = u, c = u = null), p
                            }
                        });
                    s.JSON = {
                        parse: p.parse,
            ...
            e.deconstructPacket = function(t) {
                ...
                return i.data = function t(r) {
                    ...
                    if ("object" == typeof r && !(r instanceof Date)) {
                        for (var c in s = {}, r) s[c] = t(r[c]);
                        return s
                    }
                    return r
                }(r), i.attachments = e.length, {
                    packet: i,
                    buffers: e
                }
            }, e.reconstructPacket = function(t, e) {
                return t.data = function t(r) {
                ...
                (function e(a, c, u) {
                    ...
                    if (t.Blob && a instanceof Blob || t.File && a instanceof File) {
                        ...
                        h.onload = function() {
                            u ? u[c] = this.result : s = this.result, --i || r(s)
                        }, h.readAsArrayBuffer(a)
                    } else if (n(a))
                        for (var p = 0; p < a.length; p++) e(a[p], p, a);
                    else if (a && "object" == typeof a && !o(a))
                        for (var f in a) e(a[f], f, a)
                })(s), i || r(s)
            }
        }).call(e, function() {
            return this
        ...
        function n(t, e) {
            return this instanceof n ? (t && "object" === (void 0 === t ? "undefined" : o(t)) && (e = t, t = void 0), (e = e || {}).path = e.path || "/socket.io", this.nsps = {}, this.subs = [], this.opts = e, this.reconnection(!1 !== e.reconnection), this.reconnectionAttempts(e.reconnectionAttempts || 1 / 0), this.reconnectionDelay(e.reconnectionDelay || 1e3), this.reconnectionDelayMax(e.reconnectionDelayMax || 5e3), this.randomizationFactor(e.randomizationFactor || .5), this.backoff = new l({
                min: this.reconnectionDelay(),
                max: this.reconnectionDelayMax(),
                jitter: this.randomizationFactor()
            }), this.timeout(null == e.timeout ? 2e4 : e.timeout), this.readyState = "closed", this.uri = t, this.connecting = [], this.lastPing = null, this.encoding = !1, this.packetBuffer = [], this.encoder = new c.Encoder, this.decoder = new c.Decoder, this.autoConnect = !1 !== e.autoConnect, void(this.autoConnect && this.open())) : new n(t, e)
        }
        var o = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(t) {
                return typeof t
            } : function(t) {
        ...
        (function(e) {
            ...
            var o = r(21),
                i = r(35),
                s = r(3)("engine.io-client:socket"),
                a = r(42),
                c = r(27),
                u = r(2),
                h = r(43),
                p = r(36);
            t.exports = n, n.priorWebsocketSuccess = !1, i(n.prototype), n.protocol = c.protocol, n.Socket = n, n.Transport = r(26), n.transports = r(21), n.parser = r(27), n.prototype.createTransport = function(t) {
                ...
                return e.EIO = c.protocol, e.transport = t, this.id && (e.sid = this.id), new o[t]({
                    agent: this.agent,
                ...
                function e() {
                    ...
                    p || (s('probe transport "%s" opened', t), h.send([{
                        type: "ping",
                        data: "probe"
                    }]), h.once("packet", function(e) {
                        if (!p)
                            if ("pong" === e.type && "probe" === e.data) {
                                if (s('probe transport "%s" pong', t), f.upgrading = !0, f.emit("upgrading", h), !h) return;
                                n.priorWebsocketSuccess = "websocket" === h.name, s('pausing current transport "%s"', f.transport.name), f.transport.pause(function() {
                                    p || "closed" !== f.readyState && (s("changing transport and sending upgrade packet"), u(), f.setTransport(h), h.send([{
                                        type: "upgrade"
                ...
                function o(e) {
                    ...
                    n.transport = h.name, r(), s('probe transport "%s" failed because of error: %s', t, e), f.emit("upgradeError", n)
                }
                ...
                function c(t) {
                    h && t.name !== h.name && (s('"%s" works - aborting "%s"', t.name, h.name), r())
                }

                function u() {
                    h.removeListener("open", e), h.removeListener("error", o), h.removeListener("close", i), f.removeListener("close", a), f.removeListener("upgrading", c)
                }
                ...
                var h = this.createTransport(t, {
                    ...
                    p = !1,
                    f = this;
                n.priorWebsocketSuccess = !1, h.once("open", e), h.once("error", o), h.once("close", i), this.once("close", a), this.once("upgrading", c), h.open()
            }, n.prototype.onOpen = function() {
                ...
                s("socket error %j", t), n.priorWebsocketSuccess = !1, this.emit("error", t), this.onClose("transport error", t)
            ...
            e.polling = function(e) {
                ...
                if (t.location) {
                    var c = "https:" === location.protocol,
                        u = location.port;
                    u || (u = c ? 443 : 80), r = e.hostname !== location.hostname || u !== e.port, s = e.secure !== c
                }
                if (e.xdomain = r, e.xscheme = s, "open" in new n(e) && !e.forceJSONP) return new o(e);
                ...
                try {
                    ...
                    try {
                        if (this.extraHeaders)
                            for (var o in r.setDisableHeaderCheck(!0), this.extraHeaders) this.extraHeaders.hasOwnProperty(o) && r.setRequestHeader(o, this.extraHeaders[o])
                    } catch (t) {}
        ...
        a(n, o), n.prototype.name = "polling", n.prototype.doOpen = function() {
            ...
            s.decodePayload(t, this.socket.binaryType, function(t, r, n) {
            ...
            var t = this.query || {},
                ...
                r = "";
            return !1 !== this.timestampRequests && (t[this.timestampParam] = c()), this.supportsBinary || t.sid || (t.b64 = 1), t = i.encode(t), this.port && ("https" === e && 443 !== Number(this.port) || "http" === e && 80 !== Number(this.port)) && (r = ":" + this.port), t.length && (t = "?" + t), e + "://" + (-1 !== this.hostname.indexOf(":") ? "[" + this.hostname + "]" : this.hostname) + r + this.path + t
        }
    }, function(t, e, r) {
        function n(t) {
        ...
        (function(t) {
            ...
            function i(t, r, n) {
                ...
                return o[0] = g[t.type], n(new b([o.buffer, t.data]))
            }

            function s(t, e, r) {
                for (var n = new Array(t.length), o = p(t.length, r), i = function(t, r, o) {
                        e(r, function(e, r) {
                            n[t] = r, o(e, n)
                        })
            ...
            e.encodePacket = function(e, r, s, a) {
                ...
                if (b && c instanceof t.Blob) return i(e, r, a);
                if (c && c.base64) return n(e, a);
                var u = g[e.type];
                return void 0 !== e.data && (u += s ? f.encode(String(e.data)) : String(e.data)), a("" + u)
            }, e.encodeBase64Packet = function(r, n) {
                var o, i = "b" + e.packets[r.type];
                if (b && r.data instanceof t.Blob) {
                ...
                var o = u(t);
                return r && o ? b && !y ? e.encodePayloadAsBlob(t, n) : e.encodePayloadAsArrayBuffer(t, n) : t.length ? void s(t, function(t, n) {
                ...
                var o;
                if ("function" == typeof r && (n = r, r = null), "" == t) return n(v, 0, 1);
                for (var i, s, a = "", c = 0, u = t.length; c < u; c++) {
                    var h = t.charAt(c);
                    if (":" != h) a += h;
                    else {
                        if ("" == a || a != (i = Number(a))) return n(v, 0, 1);
                        if (a != (s = t.substr(c + 1, i)).length) return n(v, 0, 1);
                        if (s.length) {
                            if (o = e.decodePacket(s, r, !0), v.type == o.type && v.data == o.data) return n(v, 0, 1);
                ...
                return t.length ? void s(t, function(t, r) {
            ...
            t.exports = function(t) {
                return function t(r) {
                    ...
                    if (n(r)) {
                        ...
                        for (var i in r.toJSON && "function" == typeof r.toJSON && (r = r.toJSON()), r)
                            if (Object.prototype.hasOwnProperty.call(r, i) && t(r[i])) return !0;
                    return !1
                }(t)
            }
        }).call(e, function() {
        ...
        (function(t, o) {
            ! function(i) {
                ...
                function c(t) {
                    ...
                    var e = "";
                    return 0 == (4294965248 & t) ? e = y(t >> 6 & 31 | 192) : 0 == (4294901760 & t) ? (e = y(t >> 12 & 15 | 224), e += a(t, 6)) : 0 == (4292870144 & t) && (e = y(t >> 18 & 7 | 240), e += a(t, 12), e += a(t, 6)), e + y(63 & t | 128)
                }

                function u() {
                    if (d >= l) throw Error("Invalid byte index");
                    var t = 255 & f[d];
                    if (d++, 128 == (192 & t)) return 63 & t;
                ...
                function h() {
                    ...
                    if (224 == (240 & t)) {
                        if ((e = (15 & t) << 12 | u() << 6 | u()) >= 2048) return e;
                        throw Error("Invalid continuation byte")
                    }
                    if (240 == (248 & t) && ((e = (15 & t) << 18 | u() << 12 | u() << 6 | u()) >= 65536 && e <= 1114111)) return e;
                    throw Error("Invalid WTF-8 detected")
                }
                var p = ("object" == typeof t && t && t.exports, "object" == typeof o && o);
                p.global !== p && p.window;
                var f, l, d, y = String.fromCharCode,
                    g = {
                        version: "1.0.0",
                        encode: function(t) {
                            for (var e = s(t), r = e.length, n = -1, o = ""; ++n < r;) o += c(e[n]);
                            return o
                        },
                        decode: function(t) {
                            f = s(t), l = f.length, d = 0;
                            for (var e, r = []; !1 !== (e = h());) r.push(e);
                            return function(t) {
                                for (var e, r = t.length, n = -1, o = ""; ++n < r;)(e = t[n]) > 65535 && (o += y((e -= 65536) >>> 10 & 1023 | 55296), e = 56320 | 1023 & e), o += y(e);
                                return o
                            }(r)
                        }
                    };
        ...
        (function(e) {
            ...
            t.exports = s ? a ? e.Blob : o : c ? n : void 0
        }).call(e, function() {
            return this
        }())
    }, function(t, e, r) {
                ...
                for (var n = t.length, o = 0, i = n; o < i; o++) ! function(t) {
                    s.encodePacket(t, r.supportsBinary, function(o) {
                        if (!r.usingBrowserWebSocket) {
                            var i = {};
                            if (t.options && (i.compress = t.options.compress), r.perMessageDeflate)("string" == typeof o ? e.Buffer.byteLength(o) : o.length) < r.perMessageDeflate.threshold && (i.compress = !1)
                        }
                        try {
                            r.usingBrowserWebSocket ? r.ws.send(o) : r.ws.send(o, i)
                        } catch (t) {
                            h("websocket closed before onclose event")
                        }--n || (r.emit("flush"), setTimeout(function() {
        ...
        i(n.prototype), n.prototype.subEvents = function() {
            ...
            return n.options.compress = !this.flags || !1 !== this.flags.compress, "function" == typeof e[e.length - 1] && (u("emitting packet with ack id %d", this.ids), this.acks[this.ids] = e.pop(), n.id = this.ids++), this.connected ? this.packet(n) : this.sendBuffer.push(n), delete this.flags, this
        }, n.prototype.packet = function(t) {
